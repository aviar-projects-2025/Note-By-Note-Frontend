...
export default function SignUpPage() {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const data = await client.fetch(signUpPageQuery);

        console.log('SignUpPage Section', data);


        if (data?.hero?._type === "signUpHeroSection") {
          setHero(data?.hero);
  ...
  console.log("BannerSection", hero);
  console.log("SignUpSection", option);
                  ...
                  >
                    ...
                    <div className="flex-1">
                      ...
                      {opt?.buttonLabel ? (
                        ...
                        >
                          <p style={{ color: 'white' }}>{opt?.buttonLabel}</p>
                        </a>
                      ) : (
