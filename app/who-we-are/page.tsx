          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              ...
              {/* <motion.div whileHover={{ scale: 1.06 }} whileTap={{ scale: 0.96 }}>
                <Link
                  href="/team"
                  className="inline-flex items-center justify-center gap-2 border border-white/60 px-6 sm:px-8 py-3 rounded-full text-white text-sm sm:text-base backdrop-blur-sm hover:bg-white/10 transition"
                >
                  Meet the Team
                </Link>
              </motion.div> */}
      ...
      <section className="py-16 sm:py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <Reveal variants={fadeRight}>
            <motion.span
              className="inline-block text-xs sm:text-sm text-[#C0392B] font-semibold tracking-widest uppercase mb-3"
              variants={fadeUp}
            >
              Our Story
            </motion.span>
            ...
            <div className="space-y-4 text-gray-600 text-sm sm:text-base leading-relaxed">
              <p>
                ...
                Preparatory and Xavier College Preparatory — recognized the deep disparities in music
                education across Phoenix. Many kids aspire to play an instrument but cannot for
                financial reasons.
              </p>
              <p>
                The Arts Education Data Project reports that over a third of Arizona K-8 students
                do not have access to music instruction, with funding being the primary barrier.
              </p>
              <p>
                Starting in mid-2023, Note By Note was created to establish financially equitable
                conditions in music education — specifically in elementary and middle schools —
                through free one-on-one instruction.
              </p>
            </div>
            ...
            <div className="mt-7 flex flex-col sm:flex-row gap-3">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.96 }}>
                <Link
                  href="/donate"
                  className="inline-flex items-center gap-2 bg-[#2B2B2B] text-white px-6 py-3 rounded-full text-sm font-semibold"
                >
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.96 }}>
                <Link
                  href="/volunteer"
                  className="inline-flex items-center gap-2 border border-[#C0392B] text-[#C0392B] px-6 py-3 rounded-full text-sm font-semibold hover:bg-[#C0392B] hover:text-white transition"
                >
                  Volunteer With Us
                </Link>
              </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="text-center mb-12">
            ...
            <p className="text-gray-500 mt-3 text-sm sm:text-base max-w-xl mx-auto">
              From a small idea to a growing movement for music equity in Arizona.
            </p>
          </Reveal>
                ...
                <Reveal key={idx} delay={idx * 0.1}>
                  <div className={`lg:grid lg:grid-cols-2 lg:gap-12 items-center ${idx % 2 === 0 ? '' : 'lg:dir-rtl'}`}>
                    <motion.div
                      ...
                      transition={{ duration: 0.2 }}
                    >
                      <span className="inline-block text-xs font-bold text-[#C0392B] bg-[#C0392B]/10 px-3 py-1 rounded-full mb-2">
                        {m.year}
                      </span>
      ...
      <section className="py-16 sm:py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="text-center mb-10 sm:mb-14">
            <span className="text-xs sm:text-sm text-[#C0392B] font-semibold tracking-widest uppercase">
            ...
            <p className="text-gray-500 mt-3 text-sm sm:text-base max-w-lg mx-auto">
              Three high-schoolers who turned a shared frustration into a statewide movement.
            </p>
          </Reveal>
      ...
      <section className="bg-[#FFFDF8] py-16 sm:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="text-center mb-10 sm:mb-14">
            ...
            <p className="text-gray-500 mt-3 text-sm sm:text-base max-w-lg mx-auto">
              Six principles that guide every lesson, every decision, every interaction.
            </p>
          </Reveal>
            ...
            {values.map((v, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="text-base sm:text-lg font-bold mb-2 group-hover:text-[#C0392B] transition-colors duration-200">
                    {v.title}
                  </h3>
          ...
          <Reveal>
            ...
            >
              ...
              <p className="mt-3 text-white/80 max-w-xl mx-auto text-sm sm:text-base relative z-10">
                Whether you donate, volunteer, or simply spread the word — every action helps
                us put an instrument in a child's hands.
              </p>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-3 justify-center relative z-10">
                <motion.div whileHover={{ scale: 1.06 }} whileTap={{ scale: 0.96 }}>
                  <Link
                    href="/donate"
                    className="inline-flex items-center gap-2 bg-white text-[#C0392B] font-bold px-7 py-3.5 rounded-full text-sm shadow-md hover:bg-[#FDEBD0] transition"
                  >
                ...
                <motion.div whileHover={{ scale: 1.06 }} whileTap={{ scale: 0.96 }}>
                  <Link
                    href="/volunteer"
                    className="inline-flex items-center gap-2 border border-white/60 text-white font-semibold px-7 py-3.5 rounded-full text-sm hover:bg-white/10 transition"
                  >
                    Volunteer
                  </Link>
                </motion.div>
