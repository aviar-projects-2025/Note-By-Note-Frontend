  ...
  return (
    <div className="min-h-screen bg-[#2B2B2B] flex items-center justify-center px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="font-heading text-6xl font-bold text-white mb-4" style={{ color: "#ffff" }}>404</h1>
        <h2 className="font-heading text-2xl font-bold text-white mb-4" style={{ color: "#ffff" }}>Page Not Found</h2>
        <p className="text-gray-400 mb-8" style={{ color: "#ffff" }}>
