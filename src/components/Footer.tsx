      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-6 xl:gap-8">
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-sm text-white/60 leading-relaxed mb-4 max-w-xs mx-auto sm:mx-0">
            ...
            <div className="flex flex-wrap gap-2 justify-center sm:justify-start">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 bg-[#E1306C] text-white text-xs font-semibold px-3 py-2.5 md:py-2 rounded-lg no-underline hover:bg-[#c1255a] transition-colors active:scale-95"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center gap-1.5 bg-[#00b964] text-white text-xs font-semibold px-3 py-2.5 md:py-2 rounded-lg no-underline hover:bg-[#009e54] transition-colors active:scale-95"
              >
  ...
  <div className="flex flex-col items-center sm:items-start sm:pl-4 md:pl-6">
    {quickLinks.map(({ href, label }) => (
      <Link
        key={href}
        href={href}
        className="block text-white/70 hover:text-white text-sm py-2 sm:py-1.5 mb-1 no-underline transition-colors active:text-white"
      >
        {label}
      </Link>
    ))}
          ...
          <div className="text-center sm:text-left">
            ...
            <div className="flex flex-col items-center sm:items-start">
              <a
                ...
                className="inline-flex items-center gap-2 text-white/70 hover:text-white text-sm py-2.5 sm:py-2 mb-2 no-underline transition-colors active:text-white"
              >
              ...
              <a
                ...
                className="inline-flex items-center gap-2 text-white/70 hover:text-white text-sm py-2.5 sm:py-2 mb-2 no-underline transition-colors active:text-white"
              >
                <i className="bi bi-file-text text-base"></i>
                Terms of Service
              </a>
            </div>
          </div>
          ...
          <div className="text-center sm:text-left">
            ...
            <p className="text-sm text-white/60 leading-relaxed mb-3 max-w-xs mx-auto sm:mx-0">
